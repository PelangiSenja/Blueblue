...
wget -q -O /etc/pam.d/common-password "https://raw.githubusercontent.com/PelangiSenja/Blueblue/main/password"
...
wget -q -O /usr/local/bin/ws-stunnel "https://raw.githubusercontent.com/PelangiSenja/Blueblue/main/ws-stunnel"
...
wget -q -O /usr/bin/badvpn-udpgw "https://raw.githubusercontent.com/PelangiSenja/Blueblue/main/newudpgw"
...
wget -q -O /etc/issue.net "https://raw.githubusercontent.com/PelangiSenja/Blueblue/main/issue.net"
...
#Optimasi Speed Mod By PelangiSenja
Add_To_New_Line(){
